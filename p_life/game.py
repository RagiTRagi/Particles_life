...
class Game:
    ...
    def reset_particles(self):
        ...
        """
        Resets particle positions, velocities, and types to new random values.
        This can be used to restart the simulation with a new random configuration
        without changing the interaction matrix.
        """
